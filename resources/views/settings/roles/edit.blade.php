...
<li class="breadcrumb-item"><a href="{{ route('settings.roles.show', $role) }}">{{ $role->name }}</a></li>
...
<div class="page-header">
  ...
  <p class="page-subtitle">Modify role details and permissions</p>
</div>

@if(in_array($role->name, ['Admin', 'Doctor', 'Nurse', 'Receptionist']))
<div class="alert-warning">
  <i class="bi bi-exclamation-triangle-fill"></i>
  <div>
    <strong>Protected Role</strong>
    <p style="margin: 4px 0 0 0; font-size: 14px;">This is a system role. Changes should be made carefully as they affect core functionality.</p>
  </div>
</div>
@endif
...
<form action="{{ route('settings.roles.update', $role) }}" method="POST">
  ...
  <div class="form-card">
    ...
    <div class="row">
      <div class="col-md-6 mb-3">
        ...
        <div class="help-text">Use a descriptive name for the role</div>
        @error('name')
  ...
  <div class="form-card">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
      ...
      <div style="display: flex; gap: 12px; align-items: center;">
        <span class="permission-counter" id="permission-counter">
          <i class="bi bi-check-circle-fill"></i>
          <span id="selected-count">{{ count($rolePermissions) }}</span> selected
        </span>
  ...
  <div class="btn-group">
    ...
    <a href="{{ route('settings.roles.show', $role) }}" class="btn-secondary">
