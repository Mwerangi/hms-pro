...
<div class="page-header">
  <h1 class="page-title">Edit Ward</h1>
  <p style="color: #6b7280; font-size: 14px; margin: 0;">Update ward information</p>
</div>
...
<form action="{{ route('wards.update', $ward) }}" method="POST">
  ...
  <div class="form-card">
    ...
    <div class="row">
      <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control @error('ward_number') is-invalid @enderror" 
               id="ward_number" name="ward_number" value="{{ old('ward_number', $ward->ward_number) }}" required>
        @error('ward_number')
      ...
      <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control @error('ward_name') is-invalid @enderror" 
               id="ward_name" name="ward_name" value="{{ old('ward_name', $ward->ward_name) }}" required>
        @error('ward_name')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
    ...
    <div class="row">
      <div class="col-md-6 mb-3">
        ...
        <select class="form-control @error('ward_type') is-invalid @enderror" 
          ...
          <option value="semi-private" {{ old('ward_type', $ward->ward_type) === 'semi-private' ? 'selected' : '' }}>Semi-Private</option>
          ...
          <option value="nicu" {{ old('ward_type', $ward->ward_type) === 'nicu' ? 'selected' : '' }}>NICU</option>
          <option value="picu" {{ old('ward_type', $ward->ward_type) === 'picu' ? 'selected' : '' }}>PICU</option>
      ...
      <div class="col-md-6 mb-3">
        ...
        <input type="number" class="form-control @error('base_charge_per_day') is-invalid @enderror" 
               ...
               value="{{ old('base_charge_per_day', $ward->base_charge_per_day) }}" 
    ...
    <div class="row">
      <div class="col-md-4 mb-3">
        ...
        <input type="text" class="form-control @error('floor') is-invalid @enderror" 
               id="floor" name="floor" value="{{ old('floor', $ward->floor) }}">
        @error('floor')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
      ...
      <div class="col-md-8 mb-3">
        ...
        <input type="text" class="form-control @error('building') is-invalid @enderror" 
               id="building" name="building" value="{{ old('building', $ward->building) }}">
        @error('building')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
    ...
    <div class="mb-3">
      ...
      <textarea class="form-control @error('description') is-invalid @enderror" 
                id="description" name="description" rows="3">{{ old('description', $ward->description) }}</textarea>
      @error('description')
      <div class="invalid-feedback">{{ $message }}</div>
      @enderror
    </div>
      ...
      <div class="col-md-6 mb-3">
        ...
        <select class="form-control @error('nurse_id') is-invalid @enderror" 
          ...
          @foreach($nurses as $nurse)
            <option value="{{ $nurse->id }}" {{ old('nurse_id', $ward->nurse_id) == $nurse->id ? 'selected' : '' }}>
        ...
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
        <small class="form-text">Assign or change the nurse managing this ward</small>
      </div>

      <div class="col-md-6 mb-3">
        <label for="contact_number" class="form-label">Contact Number</label>
        <input type="text" class="form-control @error('contact_number') is-invalid @enderror" 
               id="contact_number" name="contact_number" value="{{ old('contact_number', $ward->contact_number) }}">
  ...
  <div style="display: flex; gap: 12px;">
    ...
    <a href="{{ route('wards.show', $ward) }}" class="btn-outline">
